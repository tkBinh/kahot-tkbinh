...
<head>
    ...
    <title>Edit Quiz Title | Ká Hột</title>
...
<body>
    <nav class="navbar bg-dark">
        ...
        <div class="button-right">
            <a href="show-question.html"><button class="btn btn-success btn-sm"><b>Save & Next</b></button></a>
        </div>
    </nav>
    <div class="jumbotron room-jumbo">
        <div>
            <h1 class="text-center"><i class="fas fa-folder"></i> Edit Quiz Title</h1>
        </div>
